...
const Eyeglasses = () => {
    ...
    return (
        <div className="space-y-12">
            ...
            <Brandsection img={"https://static1.lenskart.com/media/desktop/img/Aug21/Desktop/VC-Banner.jpg"} />
            <Categoryslider className="max-w-6xl mx-auto" heading={"SUNGLASSES"} data={sunglasses} />
            <Brandsection img={"https://static1.lenskart.com/media/desktop/img/Nov22/Updated%20brand%20banner%20jj%20.jpg"} />
            <Categoryslider className="max-w-6xl mx-auto" heading={"POWERGLASS"} data={powerglasses} />
            <Brandsection img={"https://static1.lenskart.com/media/desktop/img/Aug21/25-Aug/LK-Readers-Banner.jpg"} />
            <Categoryslider className="max-w-6xl mx-auto" heading={"KIDSGLASS"} data={kidsglasses} />
            <Brandsection img={"http://static1.lenskart.com/media/desktop/img/Nov20/25-Nov/Banner05_Final2ndDec21.jpg"} />
        </div>
    );
};
